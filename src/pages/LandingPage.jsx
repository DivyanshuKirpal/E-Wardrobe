...
const LandingPage = ({ isLoggedIn, onLogin, onLogout, onNavigateToCloset }) => {
  return (
    <>
      ...
      <section
        id="hero"
        className="gradient-bg hero-pattern pt-24 pb-16 h-[800px] flex items-center"
      >
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center text-white">
          <div>
            ...
            <p className="text-xl mb-8 text-white">
              Organize, explore, and style your clothes effortlessly with AI-powered outfit recommendations and smart wardrobe management.
            </p>
              ...
              {["Free 30-day trial", "No credit card required", "Cancel anytime"].map(
                (txt, i) => (
                  <div className="flex items-center" key={i}>
                    <i className="fa-solid fa-circle-check mr-2 text-cyan-300" />
                    <span>{txt}</span>
                  </div>
                )
              )}
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-cyan-400 text-white px-4 py-2 rounded-full font-semibold">
              <i className="fa-solid fa-star mr-1" /> 4.9/5 Rating
            </div>
            <div className="absolute -bottom-4 -left-4 bg-purple-500 text-white px-4 py-2 rounded-full font-semibold">
